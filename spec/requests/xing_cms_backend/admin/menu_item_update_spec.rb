    ...
    describe "Successful update"do
      describe "PUT admin/menu_items/:id" do
        it "is a 200 success including the serialized object" do
          ...
          json_put "/xing_cms_backend/admin/menu_items/#{menu_item.id}", json_body
          ...
          expect(response.body).to be_json_eql("\"#{engine_routes.admin_menu_item_path(menu_item)}\"").at_path('links/self')
      ...
      describe 'required information omitted' do
        ...
        describe "PUT admin/menu_items/:id" do
          it "is a 422 with an error in response body" do
            json_put "/xing_cms_backend/admin/menu_items/#{menu_item.id}", invalid_json
